...
const BASE_EMAIL_TEMPLATES: Record<string, string> = {
  ...
  feliz_cumple: `<div style="text-align:center;"><h2>¡Feliz Cumpleaños! 🎂✨</h2><p>Hola <strong>{{clientName}}</strong>, hoy es tu día especial y en Nailox queremos celebrarlo contigo.</p><div style="padding:30px;background:linear-gradient(45deg,#fff1f2,#fdf2f4);border-radius:30px;margin:25px 0;"><p style="font-size:18px;margin:0;">Tienes un <strong>Regalo Especial</strong> esperándote</p><p style="font-size:32px;font-weight:black;color:#f43f5e;margin:15px 0;">20% OFF</p><p style="font-size:12px;color:#f43f5e;">Válido durante todo el mes de tu cumple</p></div><p>¡Disfruta mucho de tu día!</p></div>`,
  pedir_resena: `<h2>¿Qué tal te ha ido hoy? ⭐</h2><p>Hola <strong>{{clientName}}</strong>, ha sido un placer atenderte hoy. En Nailox nos esforzamos por darte lo mejor, y tu opinión nos ayuda muchísimo.</p><p>¿Podrías dedicarnos 1 minuto para dejarnos una reseña?</p><div style="text-align:center;margin:30px 0;"><a href="https://g.page/nailox/review" style="background:#facc15;color:#000;padding:14px 35px;border-radius:50px;text-decoration:none;font-weight:bold;">Dejar mi opinión ⭐⭐⭐⭐⭐</a></div><p>¡Gracias por tu confianza!</p>`,
  ...
  nuevo_servicio: `<h2>✨ ¡Algo nuevo llega a Nailox!</h2><p>Hola <strong>{{clientName}}</strong>, estamos constantemente innovando para ti. Acabamos de lanzar:</p><div style="overflow:hidden;border-radius:20px;background:#f8fafc;margin:25px 0;"><div style="padding:25px;"><h3>{{serviceName}}</h3><p>{{serviceDesc}}</p><a href="/" style="color:#f43f5e;font-weight:bold;text-decoration:none;">Descubrir más →</a></div></div>`,
  ...
  custom: `<h2>Hola {{clientName}} 👋</h2><p>Te enviamos este mensaje personalizado de parte del equipo de <strong>Nailox</strong>.</p><div style="padding:25px;background:#f8fafc;border-radius:20px;margin:25px 0;line-height:1.6;">{{customMessage}}</div><p>Si tienes cualquier duda, estamos a tu disposición.</p>`
};
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 20px;">
            <tr><td align="center">
              <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #fce7eb;">
                <tr><td style="background:linear-gradient(135deg,#f43f5e,#fb7185);padding:30px;text-align:center;"><span style="font-size:24px;font-weight:700;letter-spacing:4px;color:#ffffff;">NAILOX</span></td></tr>
                <tr><td style="padding:30px;">${content}</td></tr>
                <tr><td style="background:#fdf2f4;padding:20px;text-align:center;border-top:1px solid #fce7eb;color:#9ca3af;font-size:11px;">© 2026 Nailox — Sistema de Notificaciones</td></tr>
              </table>
            </td></tr>
          </table>
        </body>
            ...
            <div className="p-6 flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                {!isEditing && (
                  <>
                    <button
                      onClick={() => setSendModal({ title: t.title, body: t.body, defaultEmailBody: t.email_body, url: t.url || 'https://www.nailox.com', type: t.type })}
